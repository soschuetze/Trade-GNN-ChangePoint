...
class ProductNetwork:
    ...
    def __init__(self, year = 1962, data_dir = "data", product = 0):
        self.year = year
    ...
    def prepare_network(self):
        ...
        imports_table = imports_table[imports_table["product_category"]==self.product]
    ...
    def graph_create(self, exporter = True,
       ...
       'ZWE']
        ...
        self.pyg_graph = data.Data(edge_index = torch.tensor([self.source_nodes, self.target_nodes]),
